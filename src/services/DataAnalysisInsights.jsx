...
const Service3Hero = () => (
  <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-[#0c0d0c] text-white py-20 text-center px-4">
    ...
    <motion.p variants={fadeUp} className="text-lg md:text-xl text-[#ffffff]/80 max-w-3xl mx-auto">
      Leverage AI to transform raw data into actionable insights and predictions that drive performance.
    </motion.p>
...
const features = [
  { title: "Real-Time Dashboards", desc: "Visualize key metrics and KPIs instantly." },
  { title: "Predictive Analytics", desc: "Forecast trends using machine learning models." },
  { title: "Natural Language Queries", desc: "Ask data questions in plain English." },
  { title: "Data Cleaning & Structuring", desc: "Automatically prepare and enrich raw data." },
  { title: "AI-Powered Reports", desc: "Generate dynamic reports with insights." },
  { title: "Integration with Data Sources", desc: "Connect databases, APIs, CRMs, and IoT data." }
];
...
const benefits = [
  { title: "Faster Decisions", desc: "Access data insights in real-time for quicker actions." },
  { title: "Reduced Guesswork", desc: "Base strategies on evidence, not assumptions." },
  { title: "Improved ROI", desc: "Allocate resources more efficiently with predictive insights." },
  { title: "Better Targeting", desc: "Use data to identify high-value audiences." },
  { title: "Scalability", desc: "Analyze growing data volumes effortlessly." },
  { title: "Team Empowerment", desc: "Self-serve insights for non-technical users." }
];
...
const steps = [
  { step: "Step 1", title: "Connect Data Sources", desc: "Pull from CRMs, APIs, sensors, and spreadsheets." },
  { step: "Step 2", title: "Clean & Normalize", desc: "Ensure consistency and structure with AI tools." },
  { step: "Step 3", title: "Analyze & Predict", desc: "Run queries, detect trends, and forecast behavior." },
  { step: "Step 4", title: "Visualize & Share", desc: "Display results with dashboards and smart reports." }
];
...
const Service3CaseStudy = () => (
  <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-[#0c0d0c] text-white py-20 px-6">
    <motion.div variants={fadeUp} className="max-w-4xl mx-auto text-center">
      ...
      <p className="mb-4"><strong>Challenge:</strong> No unified customer insight; ineffective promotions.</p>
      <p className="mb-4"><strong>Solution:</strong> AI analyzed purchase behavior and optimized campaigns.</p>
...
const plans = [
  { name: "Starter", price: "$29/month", features: ["3 Dashboards", "Basic Reports", "Email Support"] },
  { name: "Pro", price: "$149/month", features: ["Unlimited Reports", "AI Forecasting", "Data API Access", "Priority Support"] },
  { name: "Enterprise", price: "Custom Quote", features: ["Data Lake Integration", "Private Cloud", "Account Manager", "24/7 SLA"] }
];
