...
import heroBg from "../assets/automation-hero.png";

const AutomationEfficiency = () => (
  <div className="bg-[#1a1a1a] text-white min-h-screen">
    {/* Hero Section */}
    <section
      className="py-20 px-6 text-center bg-center bg-cover bg-no-repeat"
      style={{
        backgroundImage: `url(${heroBg})`,
      }}
    >
      <div className="bg-black/70 p-8 rounded-lg inline-block">
        <h1 className="text-5xl font-bold mb-4 text-[#e3d271]">
          Intelligent Workflow Automation
        </h1>
        <p className="text-lg text-[#e5e5e5] max-w-2xl mx-auto mb-8">
          Streamline your business with AI-powered automation. Eliminate
          repetitive tasks, reduce errors, and boost productivity.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 bg-[#1a1a1a] rounded-xl shadow">
            ...
            <p className="text-[#808080] text-sm">
              Automate actions based on intelligent event detection and data
              analysis.
            </p>
          </div>
          <div className="p-6 bg-[#1a1a1a] rounded-xl shadow">
            ...
            <p className="text-[#808080] text-sm">
              Design workflows tailored to your unique business processes.
            </p>
          </div>
          <div className="p-6 bg-[#1a1a1a] rounded-xl shadow">
            <h3 className="text-lg font-semibold mb-2">Real-Time Monitoring</h3>
            <p className="text-[#808080] text-sm">
              Track automation performance and receive instant alerts for
              anomalies.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-[#0c0d0c] rounded-xl shadow">
            ...
            <p className="text-[#808080] text-sm">
              Minimize manual mistakes with consistent, rule-based automation.
            </p>
          </div>
          <div className="p-6 bg-[#0c0d0c] rounded-xl shadow">
            <h3 className="text-lg font-semibold mb-2">Scale Easily</h3>
            <p className="text-[#808080] text-sm">
              Handle growing workloads without increasing headcount.
            </p>
          </div>
        </div>
      </div>
          ...
          {[
            {
              ...
              desc: "Map out manual processes suitable for automation.",
            },
            {
              step: "Step 2",
              title: "Set Workflow Rules",
              desc: "Define triggers and logic for intelligent decisions.",
            },
            {
              step: "Step 3",
              title: "Deploy & Monitor",
              desc: "Push live and observe system output + alerts.",
            },
            {
              step: "Step 4",
              title: "Optimize with Insights",
              desc: "Analyze logs to refine and enhance over time.",
            },
          ].map((s, i) => (
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-[#1a1a1a] rounded-xl shadow p-8">
          <h3 className="text-xl font-semibold mb-2">
            Retailer X Automates Inventory
          </h3>
          <p className="text-[#808080] text-sm mb-4">
            Retailer X used our workflow automation to sync inventory, reduce
            stockouts, and save 20+ hours/week.
          </p>
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 bg-[#0c0d0c] rounded-xl shadow">
            ...
            <button className="bg-[#e3d271] text-[#1a1a1a] font-bold px-6 py-2 rounded-full hover:bg-[#c6b25a] transition">
              Choose
            </button>
          </div>
          <div className="p-6 bg-[#e3d271] rounded-xl shadow text-[#1a1a1a]">
            ...
            <button className="bg-[#1a1a1a] text-[#e3d271] font-bold px-6 py-2 rounded-full hover:bg-[#33331a] transition">
              Choose
            </button>
          </div>
          <div className="p-6 bg-[#0c0d0c] rounded-xl shadow">
